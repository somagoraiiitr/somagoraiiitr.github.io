...
function Frame2() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[29px] items-start left-[64px] top-[656px] w-[749px]">
      <div className="aspect-[2832/1164] relative shrink-0 w-full" data-name="MS1 1">
...
function Frame1() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[32px] items-start left-[64px] not-italic text-[#0e1010] top-[1157px] w-[769px]">
      <Content4 />
      <Content5 />
      <Content6 />
    </div>
...
export default function Component() {
  return (
    <div className="bg-[#fdfdfd] relative size-full" data-name="46">
      <div className="absolute bg-[rgba(237,221,132,0.3)] h-[31px] left-[57px] top-[1483px] w-[563px]" />
      <Heading />
      <Frame />
      <Frame2 />
      <div className="absolute bg-[rgba(237,221,132,0.3)] h-[31px] left-[60px] top-[1157px] w-[395px]" />
      <div className="absolute bg-[rgba(237,221,132,0.3)] h-[31px] left-[60px] top-[1297px] w-[557px]" />
      <Frame1 />
    </div>
  );
}