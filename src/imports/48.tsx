...
function Frame() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-start left-[64px] top-[160px] w-[653px]">
...
export default function Component() {
  return (
    <div className="bg-[#fdfdfd] relative size-full" data-name="48">
      <Heading />
      <Frame />
      <div className="absolute h-[543px] left-[calc(50%+42px)] top-[86px] w-[694px]" data-name="HN2">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgHn2} />
      </div>
      <div className="absolute h-[385px] left-[119px] top-[436px] w-[598px]" data-name="HN1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgHn1} />
      </div>
      <div className="absolute h-[333px] left-[calc(50%+33px)] top-[662px] w-[695px]" data-name="image 64">
