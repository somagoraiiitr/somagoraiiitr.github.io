...
import imgImage14 from "figma:asset/fdef8331ef79b34b96b098e060f9b8b7fdb25f1b.png";
...
export default function ControlTower() {
  ...
  return (
    <CaseStudyTemplate
      ...
      hideHero={true}
      sideNav={<ProjectSideNav sections={navSections} accentColor="#FFE24A" />}
    >
      {/* Context Section */}
      ...
      <section id="problem" style={{ marginBottom: '96px' }}>
        ...
        <div style={{ marginTop: '48px' }}>
          <h3 style={{ 
            ...
            color: '#111111', 
            marginBottom: '24px',
            background: 'rgba(255,226,74,0.25)',
            display: 'inline-block',
            padding: '4px 12px'
          }}>
            Existing Process :
